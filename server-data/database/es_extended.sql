...
-- Dump dei dati della tabella es_extended.datastore: ~0 rows (circa)
...
-- Dump dei dati della tabella es_extended.datastore_data: ~0 rows (circa)
...
-- Dump della struttura di tabella es_extended.owned_properties
...
-- Dump dei dati della tabella es_extended.owned_properties: ~0 rows (circa)
...
-- Dump della struttura di tabella es_extended.properties
...
-- Dump dei dati della tabella es_extended.properties: ~72 rows (circa)
